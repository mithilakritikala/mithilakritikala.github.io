            ...
            <div className="container mx-auto px-4 max-w-4xl">
                <div className="bg-white rounded-sm shadow-lg p-8 md:p-12 border border-[var(--color-ink)]/10">
                    ...
                    <div className="prose prose-lg max-w-none text-gray-700">
                        ...
                        <h2 className="text-xl font-semibold text-[var(--color-ink)] mt-8 mb-4">Information We Collect:</h2>
                        ...
                        <h2 className="text-xl font-semibold text-[var(--color-ink)] mt-8 mb-4">How We Use It:</h2>
                        <ul className="list-disc pl-6 mb-6 space-y-2">
                        ...
                        <h2 className="text-xl font-semibold text-[var(--color-ink)] mt-8 mb-4">Data Storage:</h2>
                        <ul className="list-disc pl-6 mb-6 space-y-2">
