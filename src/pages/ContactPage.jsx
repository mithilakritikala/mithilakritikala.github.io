    ...
    return (
        <div className="pt-24 min-h-screen bg-white pb-20">
            ...
            <div className="container mx-auto px-4 max-w-6xl">
                <PageHeader
                    title="Contact Us"
                    subtitle="Have questions about our programs, or want to partner with us? Reach out through any of the channels below."
                />

                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
                    {/* Contact Information */}
                    <Reveal className="bg-[var(--color-paper)] p-8 md:p-12 rounded-sm shadow-sm h-full">
                        <h2 className="text-2xl font-semibold text-[var(--color-ink)] mb-8">Get In Touch</h2>
                        <div className="space-y-8">
                            <div className="flex items-start gap-4 p-4 bg-white rounded-sm shadow-sm">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:contact@mithilakritikala.com" className="text-[var(--color-ink)]/70 hover:text-[var(--color-maroon)] transition-colors">
                            ...
                            <div className="flex items-start gap-4 p-4 bg-white rounded-sm shadow-sm">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+917903120432" className="text-[var(--color-ink)]/70 hover:text-[var(--color-maroon)] transition-colors">
                                        +91 7903120432
                                    </a>
                                </div>
                            </div>
                    ...
                    {/* Google Map Embed */}
                    <Reveal delay={150} className="w-full h-64 md:h-80 lg:h-full rounded-sm overflow-hidden shadow-lg border-4 border-white">
                        <iframe
                ...
                {/* Contact Form */}
                <Reveal className="bg-white rounded-sm shadow-lg p-8 md:p-12 max-w-3xl mx-auto">
                    <h2 className="text-2xl font-semibold text-[var(--color-ink)] mb-8 text-center">Send Us a Message</h2>

                    {submitted ? (
                        <div className="text-center py-10">
                            <div className="text-5xl mb-4">✅</div>
                            <h3 className="text-xl font-bold text-[var(--color-maroon)] mb-2">Message Sent!</h3>
                            <p className="text-[var(--color-ink)]/70">Thank you! We will get back to you within 24 hours.</p>
                            <button
